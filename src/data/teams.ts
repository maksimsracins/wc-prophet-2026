...
export const TEAMS: Record<string, Team> = {
  ...
  usa: {
    ...
    flag: '🇺🇸', confederation: 'CONCACAF', worldRank: 11,
  ...
  canada: {
    ...
    flag: '🇨🇦', confederation: 'CONCACAF', worldRank: 43,
  ...
  mexico: {
    ...
    flag: '🇲🇽', confederation: 'CONCACAF', worldRank: 16,
    bestResult: 'Quarter-final (1970, 1986)',
    wildFact: 'Mexico has scored in every tournament they\'ve participated in — a streak spanning over 90 years.',
    colors: ['#006847', '#CE1126'],
  },
  panama: {
    id: 'panama', name: 'Panama', shortName: 'PAN',
    flag: '🇵🇦', confederation: 'CONCACAF', worldRank: 49,
    bestResult: 'Group stage (2018)',
    wildFact: 'Panama\'s first-ever tournament goal in 2018 was celebrated so wildly that it became a national holiday.',
    colors: ['#FFFFFF', '#DA121A'],
  },
  costa_rica: {
    id: 'costa_rica', name: 'Costa Rica', shortName: 'CRC',
    flag: '🇨🇷', confederation: 'CONCACAF', worldRank: 50,
    bestResult: 'Quarter-final (2014)',
    wildFact: 'In 2014 Costa Rica beat Uruguay, Italy, and England in the group stage — the greatest group stage upset in tournament history.',
    colors: ['#002B7F', '#CE1126'],
  },
  honduras: {
    id: 'honduras', name: 'Honduras', shortName: 'HON',
    flag: '🇭🇳', confederation: 'CONCACAF', worldRank: 74,
  ...
  brazil: {
    ...
    flag: '🇧🇷', confederation: 'CONMEBOL', worldRank: 5,
    bestResult: 'Winners (1958, 1962, 1970, 1994, 2002)',
    wildFact: 'Brazil is the only nation to have played in every single tournament — all 23 editions.',
    colors: ['#009C3B', '#FFDF00'],
  },
  argentina: {
    id: 'argentina', name: 'Argentina', shortName: 'ARG',
    flag: '🇦🇷', confederation: 'CONMEBOL', worldRank: 1,
    bestResult: 'Winners (1978, 1986, 2022)',
    wildFact: 'Argentina\'s 2022 tournament win ended a 36-year drought, making Lionel Messi the only player to win the Golden Boot, Golden Ball, and the trophy in one career.',
    colors: ['#74ACDF', '#FFFFFF'],
  },
  colombia: {
    id: 'colombia', name: 'Colombia', shortName: 'COL',
    flag: '🇨🇴', confederation: 'CONMEBOL', worldRank: 9,
    bestResult: 'Quarter-final (2014)',
    wildFact: 'James Rodríguez\'s 2014 tournament goal against Uruguay was voted the best goal in tournament history.',
    colors: ['#FCD116', '#003087'],
  },
  uruguay: {
    id: 'uruguay', name: 'Uruguay', shortName: 'URU',
    flag: '🇺🇾', confederation: 'CONMEBOL', worldRank: 14,
    bestResult: 'Winners (1930, 1950)',
    wildFact: 'Uruguay won the very first global football tournament in 1930, hosted on their home soil, with a stadium built in just 8 months.',
    colors: ['#75AADB', '#FFFFFF'],
  },
  ecuador: {
    id: 'ecuador', name: 'Ecuador', shortName: 'ECU',
    flag: '🇪🇨', confederation: 'CONMEBOL', worldRank: 37,
  ...
  paraguay: {
    ...
    flag: '🇵🇾', confederation: 'CONMEBOL', worldRank: 58,
    bestResult: 'Quarter-final (1930, 2010)',
    wildFact: 'Paraguay didn\'t concede a single goal in open play during the entire 2010 tournament knockout stage.',
    colors: ['#D52B1E', '#FFFFFF'],
  },
  // UEFA
  france: {
    id: 'france', name: 'France', shortName: 'FRA',
    flag: '🇫🇷', confederation: 'UEFA', worldRank: 2,
    bestResult: 'Winners (1998, 2018)',
    wildFact: 'France\'s squad for 2018 was so young that the average age was just 26 — the youngest tournament-winning squad ever.',
    colors: ['#002395', '#ED2939'],
  },
  england: {
    id: 'england', name: 'England', shortName: 'ENG',
    flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', confederation: 'UEFA', worldRank: 4,
    bestResult: 'Winners (1966)',
    wildFact: 'England\'s only tournament win came on home soil in 1966, and the winning goal is still disputed — the ball may never have fully crossed the line.',
    colors: ['#FFFFFF', '#CF081F'],
  },
  spain: {
    id: 'spain', name: 'Spain', shortName: 'ESP',
    flag: '🇪🇸', confederation: 'UEFA', worldRank: 6,
    bestResult: 'Winners (2010)',
    wildFact: 'Spain\'s 2010 tournament campaign featured a record 7 consecutive clean sheets — they let in only 2 goals the entire run.',
    colors: ['#AA151B', '#F1BF00'],
  },
  germany: {
    id: 'germany', name: 'Germany', shortName: 'GER',
    flag: '🇩🇪', confederation: 'UEFA', worldRank: 13,
  ...
  portugal: {
    ...
    flag: '🇵🇹', confederation: 'UEFA', worldRank: 7,
    bestResult: '3rd place (1966)',
    wildFact: 'Cristiano Ronaldo has scored in every tournament he\'s appeared in — a feat no other player in history has achieved.',
    colors: ['#006600', '#FF0000'],
  },
  netherlands: {
    id: 'netherlands', name: 'Netherlands', shortName: 'NED',
    flag: '🇳🇱', confederation: 'UEFA', worldRank: 8,
    bestResult: 'Runners-up (1974, 1978, 2010)',
    wildFact: 'The Netherlands have never won the global tournament despite reaching three finals — the most finals without a trophy in football history.',
    colors: ['#FF6600', '#002F6C'],
  },
  belgium: {
    id: 'belgium', name: 'Belgium', shortName: 'BEL',
    flag: '🇧🇪', confederation: 'UEFA', worldRank: 3,
  ...
  italy: {
    ...
    flag: '🇮🇹', confederation: 'UEFA', worldRank: 10,
    bestResult: 'Winners (1934, 1938, 1982, 2006)',
    wildFact: 'Italy failed to qualify for both 2018 and 2022 — the longest absence from the global tournament for a 4-time champion.',
    colors: ['#009246', '#CE2B37'],
  },
  croatia: {
    id: 'croatia', name: 'Croatia', shortName: 'CRO',
    flag: '🇭🇷', confederation: 'UEFA', worldRank: 12,
    bestResult: 'Runners-up (2018)',
    wildFact: 'Croatia\'s squad has more players produced by the same youth academy (Dinamo Zagreb) than any other finalist in tournament history.',
    colors: ['#FF0000', '#FFFFFF'],
  },
  switzerland: {
    id: 'switzerland', name: 'Switzerland', shortName: 'SUI',
    flag: '🇨🇭', confederation: 'UEFA', worldRank: 20,
  ...
  austria: {
    ...
    flag: '🇦🇹', confederation: 'UEFA', worldRank: 25,
  ...
  denmark: {
    ...
    flag: '🇩🇰', confederation: 'UEFA', worldRank: 21,
  ...
  poland: {
    ...
    flag: '🇵🇱', confederation: 'UEFA', worldRank: 27,
    bestResult: '3rd place (1974, 1982)',
    wildFact: 'Robert Lewandowski scored Poland\'s first-ever tournament hat-trick in 2022, 60+ years into their tournament history.',
    colors: ['#DC143C', '#FFFFFF'],
  },
  serbia: {
    id: 'serbia', name: 'Serbia', shortName: 'SRB',
    flag: '🇷🇸', confederation: 'UEFA', worldRank: 33,
  ...
  turkey: {
    ...
    flag: '🇹🇷', confederation: 'UEFA', worldRank: 29,
    bestResult: '3rd place (2002)',
    wildFact: 'Turkey\'s 2002 tournament run is the only time a first-time semi-finalist has come 3rd — they were a true Cinderella story.',
    colors: ['#E30A17', '#FFFFFF'],
  },
  scotland: {
    id: 'scotland', name: 'Scotland', shortName: 'SCO',
    flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', confederation: 'UEFA', worldRank: 38,
    bestResult: 'Group stage (1974, 1978, 1982, 1986, 1990, 1998)',
    wildFact: 'Scotland appeared in 8 tournaments and never got past the group stage — but always scored at least one goal.',
    colors: ['#003F87', '#FFFFFF'],
  },
  // CAF
  morocco: {
    id: 'morocco', name: 'Morocco', shortName: 'MAR',
    flag: '🇲🇦', confederation: 'CAF', worldRank: 17,
    bestResult: '4th place (2022)',
    wildFact: 'Morocco became the first African/Arab nation to reach a global tournament semi-final when they got to the last 4 in 2022.',
    colors: ['#C1272D', '#006233'],
  },
  senegal: {
    id: 'senegal', name: 'Senegal', shortName: 'SEN',
    flag: '🇸🇳', confederation: 'CAF', worldRank: 23,
    bestResult: 'Quarter-final (2002)',
    wildFact: 'Senegal beat reigning champions France in their very first tournament game in 2002, one of the greatest upsets in football history.',
    colors: ['#00853F', '#FDEF42'],
  },
  nigeria: {
    id: 'nigeria', name: 'Nigeria', shortName: 'NGA',
    flag: '🇳🇬', confederation: 'CAF', worldRank: 35,
  ...
  egypt: {
    ...
    flag: '🇪🇬', confederation: 'CAF', worldRank: 42,
    bestResult: 'Group stage (1934, 1990)',
    wildFact: 'Egypt won the Africa Cup of Nations a record 7 times — more than any other nation — yet has only appeared at 3 global tournaments.',
    colors: ['#CE1126', '#FFFFFF'],
  },
  ivory_coast: {
    id: 'ivory_coast', name: 'Côte d\'Ivoire', shortName: 'CIV',
    flag: '🇨🇮', confederation: 'CAF', worldRank: 44,
  ...
  algeria: {
    ...
    flag: '🇩🇿', confederation: 'CAF', worldRank: 36,
  ...
  ghana: {
    ...
    flag: '🇬🇭', confederation: 'CAF', worldRank: 56,
    bestResult: 'Quarter-final (2010)',
    wildFact: 'Ghana came within a handball and a missed penalty of becoming the first African nation in a tournament semi-final in 2010.',
    colors: ['#006B3F', '#FCD116'],
  },
  cameroon: {
    id: 'cameroon', name: 'Cameroon', shortName: 'CMR',
    flag: '🇨🇲', confederation: 'CAF', worldRank: 48,
    bestResult: 'Quarter-final (1990)',
    wildFact: 'Roger Milla\'s iconic dancing goal celebration at the 1990 tournament was so beloved that organizers lowered the retirement age rule just for him.',
    colors: ['#007A5E', '#CE1126'],
  },
  south_africa: {
    id: 'south_africa', name: 'South Africa', shortName: 'RSA',
    flag: '🇿🇦', confederation: 'CAF', worldRank: 60,
    bestResult: 'Group stage (1998, 2002, 2010)',
    wildFact: 'South Africa in 2010 became the only host nation to ever be eliminated in the group stage of the global tournament.',
    colors: ['#007749', '#FFB612'],
  },
  // AFC
  japan: {
    id: 'japan', name: 'Japan', shortName: 'JPN',
    flag: '🇯🇵', confederation: 'AFC', worldRank: 18,
  ...
  south_korea: {
    ...
    flag: '🇰🇷', confederation: 'AFC', worldRank: 22,
    bestResult: '4th place (2002)',
    wildFact: 'South Korea\'s 2002 run to the semi-finals as co-host remains the greatest overachievement in tournament history by any Asian nation.',
    colors: ['#003087', '#CD2E3A'],
  },
  australia: {
    id: 'australia', name: 'Australia', shortName: 'AUS',
    flag: '🇦🇺', confederation: 'AFC', worldRank: 24,
  ...
  iran: {
    ...
    flag: '🇮🇷', confederation: 'AFC', worldRank: 32,
    bestResult: 'Group stage (1978, 1998, 2006, 2014, 2018, 2022)',
    wildFact: 'Iran is the most qualified Asian team in tournament history with 6 appearances, yet has never made it past the group stage.',
    colors: ['#239F40', '#FFFFFF'],
  },
  saudi_arabia: {
    id: 'saudi_arabia', name: 'Saudi Arabia', shortName: 'KSA',
    flag: '🇸🇦', confederation: 'AFC', worldRank: 56,
    bestResult: 'Round of 16 (1994)',
    wildFact: 'Saudi Arabia\'s 2-1 win over Argentina in 2022 was voted the greatest upset in tournament history in a fan poll.',
    colors: ['#006C35', '#FFFFFF'],
  },
  jordan: {
    id: 'jordan', name: 'Jordan', shortName: 'JOR',
    flag: '🇯🇴', confederation: 'AFC', worldRank: 67,
    bestResult: 'First tournament appearance (2026)',
    wildFact: 'Jordan qualified for their first-ever tournament in 2026, ending decades of near-misses in Asian qualifying.',
    colors: ['#007A3D', '#CE1126'],
  },
  uzbekistan: {
    id: 'uzbekistan', name: 'Uzbekistan', shortName: 'UZB',
    flag: '🇺🇿', confederation: 'AFC', worldRank: 63,
    bestResult: 'First tournament appearance (2026)',
    wildFact: 'Uzbekistan\'s 2026 qualification ended Central Asia\'s 30-year absence from the global football stage.',
    colors: ['#1EB53A', '#0099B5'],
  },
  iraq: {
    id: 'iraq', name: 'Iraq', shortName: 'IRQ',
    flag: '🇮🇶', confederation: 'AFC', worldRank: 71,
    bestResult: 'Group stage (1986)',
  ...
  new_zealand: {
    ...
    flag: '🇳🇿', confederation: 'OFC', worldRank: 98,
    bestResult: 'Group stage (1982, 2010)',
    wildFact: 'New Zealand went unbeaten in the 2010 tournament group stage, drawing all three games — yet still were eliminated.',
    colors: ['#000000', '#FFFFFF'],
  },
  // Playoff qualifiers
  venezuela: {
    id: 'venezuela', name: 'Venezuela', shortName: 'VEN',
    flag: '🇻🇪', confederation: 'CONMEBOL', worldRank: 41,
    bestResult: 'First tournament appearance (2026)',
    wildFact: 'Venezuela finally broke their duck in 2026 qualification, ending the only CONMEBOL nation\'s drought with a dramatic playoff win.',
    colors: ['#CF142B', '#003893'],
  },
  tunisia: {
    id: 'tunisia', name: 'Tunisia', shortName: 'TUN',
    flag: '🇹🇳', confederation: 'CAF', worldRank: 34,
