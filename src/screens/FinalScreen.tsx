...
export default function FinalScreen() {
  ...
  const handleShare = () => {
    if (!team) return;
    Share.share({
      message: `👑 I predict ${team.name} will win the 2026 FIFA World Cup! Can you beat my bracket? #WCProphet2026 #WorldCup2026`,
    });
  };
    ...
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View style={[styles.trophyCard, nameStyle]}>
          ...
          <Text style={styles.trophyCardLabel}>FIFA RANKING</Text>
